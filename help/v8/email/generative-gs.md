...
>abstract="要使用此功能，您必须同意 Adobe Experience Cloud 生成式 AI 用户指南以及以下内容：
* 您为此功能提供的任何提示、上下文或补充信息或其他输入(a)都必须与特定上下文绑定，该上下文可以包括您的品牌推广材料、网站内容、数据、此类数据的架构、模板或其他受信任文档，并且(b)不得包含任何个人信息（个人信息包括可以链接回特定个人的任何内容）。
* 您应该检查此功能的任何输出是否准确，并确保它适合您的用例。”
>additional-url=&quot;https://www.adobe.com/legal/licenses-terms/adobe-gen-ai-user-guidelines.html&quot; text=&quot;Adobe创作AI用户准则&quot;
