...
>[!AVAILABILITY]
>
>此功能处于有限可用状态。 请联系您的Adobe代表以获取访问权限。
...
* [片段](../content/fragments.md)在使用主题和手动样式设置模式之间不兼容。

   * 在未使用主题创建的电子邮件内容中，主题片段不可用。

   * 要在主题内容中利用[片段](../content/fragments.md)，必须使用主题创建此片段。 [了解详情](#leverage-themes-fragment)
...
* 如果使用在HTML中创建的内容，您将处于[兼容模式](existing-content.md)，并且不能将主题直接应用于此内容。
   ...
   * 要应用主题，必须先将导入的内容[另存为新模板](../content/create-email-templates.md#save-as-template)，然后将此模板转换为与主题兼容的内容。 然后，您可以使用此模板创建电子邮件内容。 在[本节](#theme-convertor)中了解如何转换使用手动样式创建的模板。
...
1. 若要开始，请创建新的[内容模板](../content/create-email-templates.md)。

1. 选择创建或编辑主题&#x200B;**[!UICONTROL 选项。]**

   ![显示“创建或编辑主题”选项的内容模板编辑器](assets/theme-create.png)

1. 选择Adobe主题。 在此示例中，选择&#x200B;**[!UICONTROL 默认主题]**&#x200B;并单击&#x200B;**[!UICONTROL 创建]**。

   已选择默认主题的![主题选择器和“创建”按钮](assets/theme-select.png)

1. 您还可以从&#x200B;**[!UICONTROL 我的主题]**&#x200B;选项卡中选择自定义模板，然后单击&#x200B;**[!UICONTROL 编辑]**&#x200B;进行更新。

   ![我的主题选项卡列出了突出显示“编辑”的自定义主题](assets/theme-edit.png)

1. 在&#x200B;**[!UICONTROL 常规设置]**&#x200B;选项卡中，通过为主题指定适合您品牌的特定名称来开始定义主题。 您可以调整电子邮件的默认视区宽度<!--and also export the current theme for reuse-->。
...
1. 使用右侧的其他选项卡，您可以单独管理此主题的每个按钮元素、分隔条、其他图像格式和网格布局间距。
   ...
   ![主题编辑器右边栏中的按钮样式控件](assets/theme-buttons.png)
...
1. 在[!DNL Adobe Campaign]中，[创建电子邮件投放](create-email.md)或从现有投放工作，或创建电子邮件[内容模板](../content/create-email-templates.md#create-template-from-scratch)，然后[编辑电子邮件内容](get-started-email-designer.md#start-authoring)。

1. 您可以选择以下操作之一：

   * 选择内置[电子邮件模板](../content/use-email-templates.md)以打开Email Designer。 系统会自动应用特定于每个模板的默认主题。

   * 从头开始设计[新内容](create-email-content.md)并选择&#x200B;**[!UICONTROL 使用主题]**&#x200B;以预定义样式主题开始。

     ![发送电子邮件至Designer开始屏幕，其中包含“使用主题”和“手动样式设置”选项](assets/theme-from-scratch.png)
...
1. 进入Email Designer后，单击右边栏上的&#x200B;**[!UICONTROL 主题]**&#x200B;按钮。 将显示默认主题或模板主题。 您可以在此主题的两个颜色变体之间切换。
   ...
   ![打开“主题”面板，显示活动的主题和颜色变体，通过电子邮件发送Designer画布](assets/theme-default-hero.png)

1. 单击当前使用的主题旁边的箭头。 此时将显示可用自定义主题和Adobe主题的列表。

   ![主题下拉列表已展开以显示Adobe主题和我的主题](assets/theme-hero-change.png)

1. 单击&#x200B;**[!UICONTROL 我的主题]**&#x200B;并选择您创建的主题。

   ![我的主题列表，在主题选取器中选择了用户创建的主题](assets/theme-select-custom.png)
...
1. 在内容模板中选择主题时，您可以单击&#x200B;**[!UICONTROL 编辑主题]**&#x200B;按钮以更新主题。 [了解详情](#create-and-edit-themes)
   ...
   使用“主题”面板中的“编辑主题”按钮的Email Designer中的![Content模板](assets/theme-edit-in-template.png){width="40%"}
...
1. 如果使用多种颜色变体来利用主题，则可以为给定结构组件选择特定变体。 这允许您为整个内容定义颜色变体，并仅对一个特定结构使用不同的变体。
   ...
   ![在“样式”选项卡中使用特定主题的变体选项的选定结构](assets/theme-structure-variant.png)
...
所选组件上的![样式选项卡显示解锁样式图标](assets/theme-unlock-style.png){width="90%"}
...
![在白色背景上具有自定义红色文本颜色的已解锁文本组件](assets/theme-unlock-style-ex-white.png){width="80%" align="center" zoomable="yes"}

如果更改主题，<!--the font size is still 14 and -->该组件的字体颜色仍为红色，但此组件的背景颜色将随新主题而更改：

![相同的解锁文本，红色保留，背景从新主题更新](assets/theme-unlock-style-ex-colored.png){width="80%"}
...
1. 在[!DNL Adobe Campaign]中，创建一个可视化片段，然后单击&#x200B;**[!UICONTROL 创建]**&#x200B;以设计片段的内容。 [了解如何操作](../content/create-fragment.md#create-from-scratch)

1. 选择&#x200B;**[!UICONTROL 使用主题]**&#x200B;以预定义样式主题开始。

   ![片段电子邮件Designer开始选项，已选择使用主题](assets/fragment-use-themes.png){width="100%"}
...
1. 单击右边栏上的&#x200B;**[!UICONTROL 主题]**&#x200B;按钮。 将显示默认主题。 您可以在此主题的不同颜色变体之间切换。
   ...
   ![电子邮件Designer中的片段内容，主题边栏显示默认主题](assets/fragment-default-theme.png){width="100%" align="center" zoomable="yes"}

1. 您可以选择其他主题来预览片段内容。 为此，请选择默认主题旁边的箭头，然后单击&#x200B;**[!UICONTROL 选择主题]**。

   ![带箭头的主题标题和为片段预览选择主题控件](assets/fragment-select-themes.png){width="40%"}

1. 您可以在&#x200B;**[!UICONTROL Adobe主题]**&#x200B;和&#x200B;**[!UICONTROL 我的主题]**&#x200B;选项卡之间导航，并为您的片段选择最多五个兼容的主题（从这两个选项卡）。

   ![使用Adobe主题和“我的主题”选项卡的“选择兼容的主题”对话框](assets/fragment-select-compatible-themes.png){width=70%}
...
1. 再次选择&#x200B;**[!UICONTROL 默认主题]**&#x200B;旁边的箭头。 现在，您可以在刚刚选择的其他主题之间切换，以预览每个样式渲染。
   ...
   ![已选择多个主题的片段画布在“主题”面板中预览](assets/fragment-selected-themes.png){width=90%}

1. 再次单击&#x200B;**[!UICONTROL 选择主题]**&#x200B;以添加更多主题或更改您的选择。

## 使模板与主题兼容 {#theme-convertor}

[!DNL Adobe Campaign]允许您将使用手动样式创建的模板转换为与主题兼容的内容。 如果在将主题引入[!DNL Adobe Campaign]之前创建内容模板，或者正在导入外部内容，则此功能会特别有用。

>[!NOTE]
>
> 只有&#x200B;**电子邮件模板**&#x200B;可以转换为与主题兼容。 无法转换单个电子邮件；必须先将内容另存为模板。

1. 打开电子邮件[内容模板](../content/create-email-templates.md)并使用Email Designer编辑其内容。

1. 选择右边栏上的&#x200B;**[!UICONTROL 主题]**&#x200B;图标，然后单击&#x200B;**[!UICONTROL 从内容生成主题]**&#x200B;按钮。

   ![主题面板，其中的“从内容生成主题”按钮突出显示](assets/generate-theme.png){width=100%}

1. 将打开&#x200B;**[!UICONTROL 创建主题]**&#x200B;窗口。 [!DNL Adobe Campaign]自动检测样式元素并将其合并到新主题中。

   ![创建主题对话框，以总结从模板内容中检测到的样式](assets/generate-theme-create-window.png){width=90%}
