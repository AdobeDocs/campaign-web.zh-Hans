...
>[!AVAILABILITY]
>
>此功能需要更新Campaign v8.6.3 <!--or v8.7.2-->。 请参阅Campaign v8客户端控制台[发行说明](https://experienceleague.adobe.com/zh-Hans/docs/campaign/campaign-v8/releases/release-notes)以了解详情。
