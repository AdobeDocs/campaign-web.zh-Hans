...
此外，可以在 Campaign Web UI 中查看您在客户端控制台中可用的所有数据和设置（从资源管理器的左侧导航中）。在[此章节](../get-started/user-interface.md#explorer-user-interface-explorer)中详细了解资源管理器视图。
...
* 种子地址现在用作 **测试用户档案**：将测试电子邮件发送到种子地址，这些地址是数据库中的其他收件人
