...
创建新受众时，会自动创建工作流并将其存储在&#x200B;**[!UICONTROL 配置文件和目标]** / **[!UICONTROL 作业]** / **[!UICONTROL 定位工作流]**&#x200B;文件夹中。

如果您被分配到自定义操作员组，并在创建受众时遇到“您没有权限”错误，则需要确保操作员组对此文件夹具有必要权限。

要解决此问题，管理员必须将您的自定义操作员组添加到Campaign控制台的文件夹安全部分。 [了解如何管理文件夹权限](../get-started/permissions.md#folder-permissions)
