...
✨ 通过我们的 [AI 助手](../v8/content/generative-gs.md)实时功能预览，享受沉浸式的实践体验，让您亲自探索其功能并充分了解其能力。
...
<table style="table-layout:auto">
  <tr style="border: 0;">
    ...
    <br/>
      <strong>开始使用</strong><br/><a href="get-started/get-started.md#web">用户界面</a> - <a href="get-started/connect-to-campaign.md">连接到 Campaign </a> - <a href="get-started/permissions.md">访问和权限</a>
    </td>
    <td>
...
* [电子邮件跟踪像素与 CNIL 指南](https://experienceleague.adobe.com/zh-hans/docs/campaign/campaign-v8/new/cnil-pixel-tracking){target="_blank"}