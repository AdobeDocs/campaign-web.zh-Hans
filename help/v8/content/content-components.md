...
1. 在电子邮件设计器中，使用现有内容或将&#x200B;**[!UICONTROL 结构组件]**&#x200B;拖放到空白内容中以定义电子邮件版面。[了解如何操作](create-email-content.md)
...
1. 使用右侧的&#x200B;**[!UICONTROL 组件设置]**&#x200B;窗格调整每个组件的样式属性。例如，您可以更改每个组件的文本样式、内边距或边距。[了解有关对齐方式和内边距的更多信息](alignment-and-padding.md)

   ![](assets/email_designer_content_components_settings.png)

在从头开始创建电子邮件内容时，**[!UICONTROL 内容组件]**允许您使用原始空白组件进一步个性化电子邮件，这些组件一经放入电子邮件中即可使用。
您可以将所需数量的**[!UICONTROL 内容组件]**&#x200B;添加到&#x200B;**[!UICONTROL 结构组件]**&#x200B;中来定义电子邮件版面。
...
1. 单击新添加的按钮以个性化文本，并访问电子邮件设计器右侧窗格中的&#x200B;**[!UICONTROL 组件设置]**。

   ![](assets/email_designer_14.png)

1. 在&#x200B;**[!UICONTROL 链接]**&#x200B;字段中，添加在单击按钮时要重定向到的 URL。
...
使用&#x200B;**[!UICONTROL 文本]**&#x200B;组件将文本插入电子邮件中，并使用&#x200B;**[!UICONTROL 组件设置]**&#x200B;窗格调整样式（边框、大小、内边距等）。

1. 从&#x200B;**[!UICONTROL 内容组件]**&#x200B;中，将&#x200B;**[!UICONTROL 文本]**&#x200B;拖放到&#x200B;**[!UICONTROL 结构组件]**&#x200B;中。

   ![](assets/email_designer_11.png)

1. 单击新添加的组件以个性化文本，并访问电子邮件设计器的右侧窗格中的&#x200B;**[!UICONTROL 组件设置]**。
...
1. 从以下位置调整其他样式属性，例如文本颜色、字体系列、边框、内边距、边距等：**[!UICONTROL 组件设置]**&#x200B;窗格。
...
您可以从&#x200B;**[!UICONTROL 组件设置]**&#x200B;窗格调整样式属性，例如线条颜色、样式和高度。
...
1. 从&#x200B;**[!UICONTROL 内容组件]**&#x200B;中，将&#x200B;**[!UICONTROL 图像]**&#x200B;组件拖放到&#x200B;**[!UICONTROL 结构组件]**&#x200B;中。

   ![](assets/email_designer_9.png)

1. 单击&#x200B;**[!UICONTROL 浏览]**&#x200B;可从您的资产中选择图像文件。

1. 单击新添加的组件并使用&#x200B;**[!UICONTROL 组件设置]**&#x200B;窗格设置图像属性：
...
1. 调整其他样式属性（例如边距、边框等）或者从&#x200B;**[!UICONTROL 组件设置]**&#x200B;窗格中添加链接，以将受众重定向到其他内容。
...
1. 在&#x200B;**[!UICONTROL 组件设置]**&#x200B;窗格的&#x200B;**[!UICONTROL 社交]**&#x200B;字段中，选择要添加或删除的社交媒体。
...
1. 从以下位置调整其他样式属性（例如样式、边距、边框等）：**[!UICONTROL 组件设置]**&#x200B;窗格。
