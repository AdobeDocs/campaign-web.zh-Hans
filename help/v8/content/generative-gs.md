...
1. **访问[Admin Console](https://adminconsole.adobe.com/)**，导航到&#x200B;**产品**&#x200B;菜单，然后选择&#x200B;**Adobe Campaign Managed Cloud**。

1. 访问要为其授予权限的实例，然后单击&#x200B;**新建配置文件**&#x200B;以使用以下特定的产品配置文件名称创建新的产品配置文件：
...
1. **添加用户或用户组**。 选择下列选项之一：
   ...
   * **添加用户组**：创建用户组，将用户添加到该组，然后将该用户组添加到产品配置文件。
