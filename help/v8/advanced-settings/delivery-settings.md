...
>[!NOTE]
>
>类型规则在Campaign Client Console中配置。 在[Campaign v8 (Client Console)文档](https://experienceleague.adobe.com/docs/campaign/automation/campaign-optimization/consistency-rules.html?lang=zh-Hans){target="_blank"}中了解详情。
