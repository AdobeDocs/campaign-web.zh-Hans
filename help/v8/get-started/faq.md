...
Adobe Campaign v8 中的新用户界面与 Adobe Experience Platform 保持一致，旨在提高营销效率。 新的工作流程画布为受众构成、工作流程管理和内容设计提供了直观而先进的工作区，并集成了 Adobe Experience Platform 原生应用程序（如 Journey Optimizer 和 Real-Time CDP）用例。 利用WYSIWYG消息设计器中原生嵌入的生成内容，激发创意、提高工作效率和大规模个性化跨渠道营销活动。
