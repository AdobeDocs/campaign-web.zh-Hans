...
![上下文帮助功能建议的问题](assets/do-not-localize/suggested-questions.png){width="600" align="left"}{zoomable="yes"}
...
![上下文帮助功能复制答案](assets/do-not-localize/copy-answer.png){width="600" align="left"}{zoomable="yes"}
