...
[上下文帮助中建议问题的示例](assets/do-not-localize/suggested-questions.png){width="600"}{zoomable="yes"}
...
[在上下文帮助中复制答案的示例](assets/do-not-localize/copy-answer.png){width="600"}{zoomable="yes"}
