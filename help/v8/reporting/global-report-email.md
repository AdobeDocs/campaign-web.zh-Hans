...
**[!UICONTROL 投放概述]**&#x200B;提供了关键绩效指标(KPI)，可深入分析访客与每个电子邮件投放的交互情况。 这些量度概述如下。
...
>title="投放统计信息"
>abstract="**投放统计信息**&#x200B;关键绩效指标 (KPI) 全面概述您的投放和营销活动效果，其中可了解成功投放次数、遇到的错误数和用户参与情况。"
...
**[!UICONTROL URL和点击流]**&#x200B;报表提供了关键绩效指标(KPI)，用于详细分析投放期间收到最多点击数的URL。 指标详见下文。
