...
分类允许您在所有投放中标准化业务实践。 **分类**&#x200B;是&#x200B;**分类规则**&#x200B;的集合，可让您控制、筛选投放并为其设置优先级。 在准备阶段，将从投放受众中排除符合类型规则中的条件的轮廓。
...
>title="类型属性"
>abstract="定义类型的属性并展开&#x200B;**[!UICONTROL 其他选项]**&#x200B;部分以访问高级设置。 使用&#x200B;**[!UICONTROL IP相关性]**&#x200B;字段将IP相关性与类型相关联。 这样，您可以通过定义每个关联可以使用哪些特定IP地址，更好地控制出站SMTP流量。"
...
## 创建分类规则 {#typology-rule}

>[!CONTEXTUALHELP]
>id="acw_business_rules_typology_rules_properties"
>title="类型规则属性"
>abstract="定义分类规则的属性。 **控制**&#x200B;规则验证消息质量和有效性预发送，而&#x200B;**筛选**&#x200B;规则根据特定条件排除目标受众的区段。<br/><br/>您还可以更改规则的执行顺序来管理在同一消息处理阶段执行同一类型的多个规则时，将执行分类规则的顺序。"
...
1. 选择分类规则的&#x200B;**[!UICONTROL 类型]**：
   ...
   * **筛选**&#x200B;规则根据特定条件（如年龄、位置、国家/地区、电话号码）排除目标受众的区段。 这些规则链接到定向维度。
...
>title="筛选"
>abstract="**筛选**&#x200B;规则根据特定条件（如年龄、位置、国家/地区、电话号码）排除目标受众的区段。 选择分类规则的定向维度并单击&#x200B;**[!UICONTROL 添加规则]**&#x200B;按钮以访问查询建模器并构建规则。"

>[!CONTEXTUALHELP]
>id="acw_business_rules_typology_rules_code"
>title="代码"
>abstract="**控制**&#x200B;规则验证消息质量和预发送的有效性（例如，字符显示、短信长度、地址格式、URL缩短）。 它们是使用JavaScript代码创建的。"
