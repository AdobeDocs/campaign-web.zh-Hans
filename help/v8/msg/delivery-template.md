...
>title="投放模板"
>abstract="为了加速和改进设计流程，您可以创建投放模板，以便在整个营销活动中轻松重复使用自定义内容和设置。该功能使您能够使创意外观标准化，以加快执行和开展营销活动的速度。"

为了加速和改进设计流程，您可以创建投放模板，以便在整个营销活动中轻松重复使用自定义内容和设置。该功能使您能够使创意外观标准化，以加快执行和开展营销活动的速度。
